...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            item_catalog_v2::get_never_override_icon_slugs,
            ...
            trades::get_portfolio_inventory_value,
            trades::get_set_completion_owned_item_prices,
            trades::import_wfm_trade_log,
            ...
            listing_close::settle_listing_for_manual_trade,
            ...
            commands::get_worldstate_vault_trader,
            ...
            ee_log_shadow::record_ee_log_trades_to_log,
            ...
            market_observatory::sync_owned_items_from_alecaframe,
